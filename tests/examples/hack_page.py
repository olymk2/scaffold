...
web.page.append(web.google_plus.render())

web.google_analytics.create('http://www.example.com','UA-XXXXXXXX-X')

web.google_analytics.render()

web.like.create(url='www.google.co.uk', facebook=True, plus=True)
web.template.body.append(web.like.render())

#append the html into the document body
web.template.body.append(web.page.render())

print web.render().encode('UTF-8')

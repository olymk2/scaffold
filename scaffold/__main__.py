...
migrate_parsers.add_argument('--database', default=None, help='database name')
migrate_parsers.add_argument('--username', default=None, help='database username')
migrate_parsers.add_argument('--password', default=None, help='database password')
migrate_parsers.add_argument('--host', default=None, help='database host')
migrate_parsers.add_argument('--type',  default='mysql', help='database type')
migrate_parsers.add_argument('--port',  type=int, default=3306, help='')
migrate_parsers.add_argument('--target', default='./data/migrate', help='Generate migrations')
...
migrate_parsers.add_argument('--port', default=3306, help='')
